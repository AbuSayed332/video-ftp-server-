...
export default function Description({ video }) {
  ...
  const [deleteVideo, { isLoading, isSuccess, isError }] = useDeleteVideoMutation(id);
  ...
  return (
      <div>
        ...
        <div className="pb-4 flex items-center space-between border-b gap-4">
          ...
          <div className="flex gap-6 w-full justify-end">
            ...
            <div className="flex gap-1 cursor-pointer" onClick={handleDelet}>
              <div className="shrink-0">
      ...
      {!isLoading && isError && <Error massage = "There was an deleting video error!" />}
      </div>
    );
}
